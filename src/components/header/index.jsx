            ...
            <div className={styles.bar}>
                ...
                <div onClick={() => {setIsActive(!isActive)}} className={styles.el}>
                    ...
                    <div className={styles.label}>
                        <motion.p className="text-black" variants={opacity} animate={!isActive ? "open" : "closed"}>Menu</motion.p>
                        <motion.p className="text-black" variants={opacity} animate={isActive ? "open" : "closed"}>Close</motion.p>
                    </div>
                </div>
